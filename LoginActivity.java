...
NhanVienDAO dao;
    ...
    public void checkLogin(){
        ...
        if(strUser.isEmpty()||strPass.isEmpty()){
            Toast.makeText(getApplicationContext(),"Yêu Cầu Nhập Thông Tin",Toast.LENGTH_SHORT).show();
        }else{
            if(dao.checkLogin(strUser,strPass)>0 || (strUser.equals("admin")&& strPass.equals("admin"))){
                ...
                Toast.makeText(getApplicationContext(),"Tài Khoản & Mật Khẩu Không Chính Xác",Toast.LENGTH_SHORT).show();
            }
